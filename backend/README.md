...
- PostgreSQL: Phase 2 (current)
- Django Admin configuration: Phase 3
- Cloudinary media: Phase 4
- Django REST Framework: Phase 5
- Railway deployment: Phase 10

The catalogue schema is included in this phase, but catalogue content is not migrated
until Phase 6. There are no API resources, Cloudinary integration, or deployment
configuration.
